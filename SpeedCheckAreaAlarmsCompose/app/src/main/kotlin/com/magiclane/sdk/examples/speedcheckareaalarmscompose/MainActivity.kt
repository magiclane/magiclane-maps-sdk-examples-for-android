...
import com.magiclane.sdk.examples.speedcheckareaalarmscompose.ui.components.SpeedCheckAreaAlarmsApp
...
class MainActivity : ComponentActivity(), SoundUtils.ITTSPlayerInitializationListener {
    ...
    private val viewModel: SpeedCheckAreaAlarmsModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MagicLaneTheme {
                SpeedCheckAreaAlarmsApp(Modifier.fillMaxSize())
            }
        }
