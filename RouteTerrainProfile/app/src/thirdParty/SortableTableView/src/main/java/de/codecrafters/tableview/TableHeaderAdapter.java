...
public abstract class TableHeaderAdapter extends ArrayAdapter {
    ...
    public final View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (headerHeight == 0)
        {
            ...
            headerHeight = Math.min(screenWidth, screenHeight) * 3 / 20;
        }

        final AbsListView.LayoutParams rowLayoutParams = new AbsListView.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, headerHeight);
        ...
        for (int columnIndex = 0; columnIndex < getColumnModel().getColumnCount(); columnIndex++) {
            ...
            final LinearLayout.LayoutParams cellLayoutParams = new LinearLayout.LayoutParams(cellWidth, headerHeight);
