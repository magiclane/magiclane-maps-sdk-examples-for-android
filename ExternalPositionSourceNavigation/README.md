...
- Present a map.
- Navigate to a given landmark using an external data source. GPS positions are hardcoded in the app and they are provided to the SDK via an "ExternalDataSource" object.
