...
import com.magiclane.sdk.examples.socialeventvotingcompose.ui.components.SocialEventVotingApp
...
class MainActivity : ComponentActivity(), SoundUtils.ITTSPlayerInitializationListener {
    ...
    private val viewModel: SocialEventVotingModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MagicLaneTheme {
                SocialEventVotingApp(Modifier.fillMaxSize())
            }
        }
