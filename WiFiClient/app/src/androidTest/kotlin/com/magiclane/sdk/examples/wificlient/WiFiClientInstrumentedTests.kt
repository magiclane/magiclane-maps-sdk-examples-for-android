...
/**
 * Instrumented tests for the WiFiClient discovery screen.
 *
 * The client app itself does not use the GEM SDK; it only needs a network to discover
 * WiFiServer instances via DNS-SD, so these tests verify the discovery UI comes up and that
 * the device has an active network. End-to-end data transfer requires a second device running
 * WiFiServer and is not covered here.
 */
@LargeTest
@RunWith(AndroidJUnit4ClassRunner::class)
class WiFiClientInstrumentedTests {
