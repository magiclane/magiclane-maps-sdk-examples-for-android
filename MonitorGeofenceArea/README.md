...
- Present a map.
- Log in using Login.registerExternalLogin
- Add two geofence areas to social service server
- Simulate a route, publish GPS positions on social service server, monitor the added geofence areas
