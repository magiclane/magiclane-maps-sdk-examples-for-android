...
BLE client for BLEServer1 example. It displays navigation instructions received from server. Turn images are transferred as bitmaps.

## Requirements

- Deployment target device must run min Android API 23.
