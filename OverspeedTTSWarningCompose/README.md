...
- Display the current speed and the road speed limit in a speed panel (the `SpeedPanel` composable from the maps-compose library).
- Highlight the panel and play a text-to-speech warning ("Mind your speed") while driving over the speed limit, at most once every 5 minutes.
- Use Jetpack Compose.
