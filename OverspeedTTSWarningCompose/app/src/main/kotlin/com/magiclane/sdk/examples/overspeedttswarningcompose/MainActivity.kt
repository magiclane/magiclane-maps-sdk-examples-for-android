...
import com.magiclane.sdk.examples.overspeedttswarningcompose.ui.components.OverspeedTTSWarningApp
...
class MainActivity : ComponentActivity(), SoundUtils.ITTSPlayerInitializationListener {
    ...
    private val viewModel: OverspeedTTSWarningModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MagicLaneTheme {
                OverspeedTTSWarningApp(Modifier.fillMaxSize())
            }
        }
