...
android {
    namespace = "com.magiclane.sdk.examples.activationmodescompose"

    compileSdk = shared.versions.compileSdkVersion.get().toInt()

    defaultConfig {
        applicationId = "com.magiclane.sdk.examples.activationmodescompose"
...
dependencies {
    ...
    // Renders the activation request blob as a QR code for the Magic Lane companion app.
    implementation(shared.zxing.core)
