...
- Display a Magic Earth style panel while approaching / traveling the speed check area: entry gantry icon, distance to the entry ("in 450 m") or to the exit ("out in 1.2 km") and the running average speed, shown in red when it exceeds the enforced limit.
