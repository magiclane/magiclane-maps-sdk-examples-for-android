...
package com.generalmagic.sdk.examples.app
...
import com.generalmagic.sdk.examples.activities.BaseActivity
...
import com.generalmagic.sdk.examples.services.SettingsInstance
...
//        showToast("Waiting for valid position")
    ...
    fun handleGeoUri(uriString: String) = SdkCall.execute {
        ...
        if (uriString.indexOf("geo:0,0?") == -1) {
            ...
            if (tmp.isNotEmpty()) {
                referencePoint = com.generalmagic.sdk.examples.util.Util.parseCoordinates(tmp)
            }
        }

        if (pos > 0) {
            val parameters =
                com.generalmagic.sdk.examples.util.Util.getParameters(uriString.substring(pos + 1))
            ...
            for (parameter in parameters) {
                ...
                if (name == "q") {
                    ...
                    if (referencePoint == null) {
                        referencePoint =
                            com.generalmagic.sdk.examples.util.Util.parseCoordinates(value)
