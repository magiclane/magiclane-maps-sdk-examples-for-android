...
import com.generalmagic.sdk.examples.androidAuto.screens.SearchScreen
...
class SearchTextController(context: CarContext) : SearchScreen(context) {
    ...
    override fun updateData() {
        ...
        actionStripModelList.add(UIActionModel(
            ...
            onClicked = {
                Service.show(SearchTextSettingsController(context))
            }
        ))
    ...
    private fun getItems(
        ...
        return SdkCall.execute {
            ...
            for (searchResult in searchResultList) {
                ...
                model.onClicked = {
                    Service.show(RoutesPreviewController(context, searchResult))
                }
