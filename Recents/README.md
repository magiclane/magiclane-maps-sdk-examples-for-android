...
- How to create a landmark store and use it as a "Recents" history.
- How to add a landmark to the store, moving it to the most recent position if it is already there.
- How to list the stored landmarks in reverse order (most recently added first).
