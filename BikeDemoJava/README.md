...
- Setup a bike routing profile. 
- Start simulation from the current position to a given landmark if a route can be calculated.

**Note:** This is a Java version of the BikeDemo example.
