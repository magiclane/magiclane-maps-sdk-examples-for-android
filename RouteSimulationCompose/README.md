...
- Present a map.
- Start simulated navigation between 2 given landmarks (London to Paris).
- Displays turn-by-turn navigation instructions, estimated time of arrival, remaining time and distance.
- Displays sign post and road code images when available.
- Displays traffic event information along the route.
- Use Jetpack Compose.
