...
- Capture a screenshot of the map view by tapping the "Take Screenshot" button at the bottom of the screen.
- Preview the captured screenshot in a bottom sheet dialog.

## Requirements

- The target device must be running Android 8.0 (API level 26) or higher to use the screenshot feature.
