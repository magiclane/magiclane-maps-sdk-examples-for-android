...
- Build the whole catalog UI with classic Android views: a `RecyclerView` with diffed row models, custom segmented-tab and circular download-progress widgets, and `ItemTouchHelper` swipe-to-delete. This is the views twin of the `MapsCatalogCompose` example.
