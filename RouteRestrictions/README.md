...
- Present a map.
- Start simulated navigation between 2 given landmarks using a truck (lorry) route profile with a mass exceeding 3500 kg.
- Listen for route restrictions during navigation.
- Display active route restrictions in a dedicated info panel below the navigation instruction panel.
