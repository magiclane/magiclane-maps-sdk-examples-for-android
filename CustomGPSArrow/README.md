...
- Present a map.
- Start simulated navigation between 2 given landmarks if a route can be calculated, using a custom GPS arrow.

## Requirements

- Deployment target device must run minimum Android API Level 19.
