...
public abstract class TableDataAdapter<T> extends ArrayAdapter<T> {
    ...
    public final View getView(final int rowIndex, final View convertView, final ViewGroup parent)
    {
        ...
        if (rowHeight == 0)
        {
            ...
            rowHeight = Math.min(screenWidth, screenHeight) * 3 / 20;
        }

        final AbsListView.LayoutParams rowLayoutParams = new AbsListView.LayoutParams(LayoutParams.MATCH_PARENT, rowHeight);
        ...
        for (int columnIndex = 0; columnIndex < columnModel.getColumnCount(); columnIndex++) {
            ...
            final LinearLayout.LayoutParams cellLayoutParams = new LinearLayout.LayoutParams(cellWidth, rowHeight);
