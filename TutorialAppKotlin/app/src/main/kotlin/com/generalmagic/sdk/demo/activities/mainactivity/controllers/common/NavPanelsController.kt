...
package com.generalmagic.sdk.demo.activities.mainactivity.controllers.common
...
import com.generalmagic.sdk.core.AlarmService
...
import com.generalmagic.sdk.datasource.PositionData
...
import com.generalmagic.sdk.demo.util.Util.Companion.setPanelBackground
...
class UINavDataProvider {
    ...
    fun updatePositionInfo(
        ...
        var speedLimit = 0.0
        if (navInstr != null && navInstr.getNavigationStatus() == SdkError.KNoError.value) {
    ...
    fun updateNavigationInfo(
        ...
        val getRemainingTravelTime: () -> Int = {
            val totalTime = if (navInstr.getNavigationStatus() == SdkError.KNoError.value) {
        ...
        val getRemainingTravelDistance: () -> Int = {
            if (navInstr.getNavigationStatus() == SdkError.KNoError.value) {
    ...
    data class NavInfo(
        ...
        var rttColor: Rgba = Rgba(0, 0, 0, 0),
        var rtd: String? = null,
