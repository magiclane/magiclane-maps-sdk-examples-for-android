...
import com.generalmagic.sdk.d3scene.MarkerOverlaysService
import com.generalmagic.sdk.datasource.*
import com.generalmagic.sdk.demo.activities.RouteDescriptionActivity
...
abstract class BaseNavControllerLayout(context: Context, attrs: AttributeSet?) :
    ...
    protected open fun onNavigationEnded(errorCode: Int = SdkError.KNoError.value) {}
        ...
        SdkCall.execute {
            ...
            if (availableOverlays != null) {
                for (item in availableOverlays) {
                    if (item.getUid() == ECommonOverlayId.EOID_Safety.value) {
...
open class PredefNavController(context: Context, attrs: AttributeSet?) :
    ...
    private fun doSearch() {
        ...
        if (posServiceError != SdkError.KNoError) {
            GEMApplication.postOnMain {
