...
import com.generalmagic.sdk.datasource.*
import com.generalmagic.sdk.demo.R
import com.generalmagic.sdk.demo.activities.ChapterLISIAdapter
import com.generalmagic.sdk.demo.activities.GenericListActivity
import com.generalmagic.sdk.demo.activities.ListItemStatusImage
import com.generalmagic.sdk.demo.activities.settings.SettingsProvider
import com.generalmagic.sdk.demo.activities.settings.TBoolSettings
import com.generalmagic.sdk.demo.activities.settings.TIntSettings
import com.generalmagic.sdk.demo.app.BaseActivity
import com.generalmagic.sdk.demo.app.GEMApplication
import com.generalmagic.sdk.demo.app.GEMApplication.postOnMain
...
// 			Log.d("GEMSDK", "zzzzz")
    ...
    override fun doStart() {
        SdkCall.execute {
            ...
            } ?: Pair(SdkError.KInvalidInput.value, -1)
...
//                        drawer?.uploadFrame(bufferType, buffer, width, height, format, rotation)
    ...
    fun doStart() = SdkCall.execute {
        ...
        this.drawer?.setFrameFit(EFrameFit.eFitInside)
//        this.drawer?.setFrameFit(EFrameFit.eStretch)
...
//            val chunkLengthInMin = 5 //or RecorderConfiguration.INFINITE_RECORDING
            ...
            Executors.newSingleThreadExecutor().submit {
                SdkCall.execute {
                    ...
                    if (startError == SdkError.KNoError) {
