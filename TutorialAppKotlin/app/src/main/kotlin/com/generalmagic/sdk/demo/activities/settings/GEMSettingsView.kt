...
class TravelModeCarOptions(m_text: String, setting: Int) : COptionsListItem(m_text, setting) {
    init {
        m_options.add(
            Pair(Utils.getUIString(StringIds.eStrFastest), ERouteType.ERT_Fastest.value)
        )
        m_options.add(
            Pair(Utils.getUIString(StringIds.eStrShortest), ERouteType.ERT_Shortest.value)
        )
    }
}
...
class UnitsSystemOptions(m_text: String, setting: Int) : COptionsListItem(m_text, setting) {
    init {
        m_options.add(
            Pair(Utils.getUIString(StringIds.eStrInKilometres), EUnitSystem.EMetric.value)
        )
        m_options.add(
            Pair(
                Utils.getUIString(StringIds.eStrInMilesFeet),
                EUnitSystem.EImperialUS.value
            )
        )
        m_options.add(
            Pair(
                Utils.getUIString(StringIds.eStrInMilesYards),
                EUnitSystem.EImperialUK.value
            )
        )
    }
}
