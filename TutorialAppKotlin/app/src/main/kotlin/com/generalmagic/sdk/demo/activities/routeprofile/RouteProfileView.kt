...
class RouteProfileView(val parent: IMapControllerActivity) {
    ...
    private val fullMapViewCoords = RectF(0.0f, 0.0f, 1.0f, 1.0f)
    private val topUpMapViewCoords = RectF(0.0f, 0.5f, 1.0f, 1.0f)
    private val rightMapViewCoords = RectF(0.5f, 0.0f, 1.0f, 1.0f)
