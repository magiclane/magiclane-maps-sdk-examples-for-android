package com.generalmagic.gemsdk.demo.activities.history

import com.generalmagic.gemsdk.Route
import com.generalmagic.gemsdk.RouteBookmarks
import com.generalmagic.gemsdk.RoutePreferences
...
class Trip {
    ...
    fun set(route: Route?, isFromAToB: Boolean) {
        ...
        route?.let {
            ...
            preferences?.let {
                mPreferences = RoutePreferences(preferences)
            }
        } ?: run {
            mWaypoints?.clear()
        }
...
class TripsHistory {
    ...
    fun loadTrip(index: Int): Pair<Boolean, Trip?> {
        mRouteBookmarks?.let { routeBookmarks ->
            ...
            preferences?.let {
                trip.mPreferences = RoutePreferences(preferences)
            }
