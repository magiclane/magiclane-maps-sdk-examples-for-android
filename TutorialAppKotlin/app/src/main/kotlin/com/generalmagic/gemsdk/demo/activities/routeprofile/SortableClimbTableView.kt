...
class SortableClimbTableView @JvmOverloads constructor(context: Context?, attributes: AttributeSet? = null, styleAttributes: Int = android.R.attr.listViewStyle) : SortableTableView<Climb?>(context, attributes, styleAttributes)
{
    init
    {
...
class ClimbTableDataAdapter(context: Context?, data: List<Climb?>?, tableView: TableView<Climb?>?) : LongPressAwareTableDataAdapter<Climb?>(context, data, tableView)
{
    // ---------------------------------------------------------------------------------------------
    ...
    {
        val view = layoutInflater.inflate(R.layout.cell_start_end_points_elevation, parentView, false)
        setColor(climb, view)
...
class Climb(var rating: String, var startEndPoint: String, var length: String, var startEndElevation: String, var avgGrade: String)
